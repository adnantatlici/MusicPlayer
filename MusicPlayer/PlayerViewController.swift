...
class PlayerViewController: UIViewController {
    ...
    func configure() {
        ...
        songNameLabel.font = songNameLabel.font.withSize(30)
        artistNameLabel.font = artistNameLabel.font.withSize(20)
        albumNameLabel.font = albumNameLabel.font.withSize(20)
    ...
    @objc func didTabPlayPauseButton() {
